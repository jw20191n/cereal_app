...
user1 = User.create(name: "Amber", img_url: "https://media1.tenor.com/images/e991362990712aac395830034b982d1b/tenor.gif?itemid=4522207", group_id: g1.id, username: "amber", password: "123")
user2 = User.create(name: "Claire", img_url: "https://thumbs.gfycat.com/LawfulIdealAlaskanhusky-size_restricted.gif", group_id: g2.id, username: "claire", password: "123")
